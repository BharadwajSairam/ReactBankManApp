...
const Account = (props) => {
    ...
    useEffect(() => {
        ...
        axios.post('http://ec2-18-208-201-20.compute-1.amazonaws.com/getAccounts',{username}).then(res=>{
    ...
    const createaccount = () => {
        ...
        axios.post('http://ec2-18-208-201-20.compute-1.amazonaws.com/addAccount',{account}).then(res=>{
            console.log(res.data);
