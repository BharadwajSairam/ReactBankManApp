...
const Dashboard = (props) => {
    ...
    useEffect(() => {
        ...
        axios.post('http://ec2-18-208-201-20.compute-1.amazonaws.com/getUser', {propUser}).then(res => {
    ...
    const HandleEdit = (e) => {
        ...
        axios.post('http://ec2-18-208-201-20.compute-1.amazonaws.com/updateUser',{editedUser}).then(res=>{
